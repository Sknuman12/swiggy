...
export const Card = (props) => {
  return (
    <div className='w-full md:w-[273px] shrink mb-3'>
        <div className='group h-[182px] rounded-[15px] overflow-hidden relative'>
            ...
            <div className='imageoverlay absolute w-full h-full top-0 text-white flex items-end p-2 font-bold text-[20px] tracking-tighter'>
            {props.offer}
            </div>
        </div>
        <div className='mt-xl font-bold'>
            {props.title}
        </div>
        <div>
